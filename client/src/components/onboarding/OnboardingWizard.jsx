...
const OnboardingWizard = () => {
  ...
  const validateStep = (step) => {
    ...
    switch (step) {
      ...
      case 4:
        ...
        if (!formData.funding_amount) newErrors.funding_amount = 'Funding amount is required';
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // Add traction
      if (formData.key_metrics || formData.achievements.length > 0 || formData.milestones.length > 0) {
        const traction = {
