...
const Step5Traction = ({ formData, updateFormData }) => {
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-2xl font-bold text-white mb-2">Traction & Evidence</h2>
        <p className="text-gray-400">Share concrete outcomes and social proof.</p>
      </div>

      <div>
        <label className="block text-sm font-medium text-gray-300 mb-2">Key Metrics</label>
        <textarea
      ...
      <div>
        <label className="block text-sm font-medium text-gray-300 mb-2">Major Achievements</label>
        <textarea
      ...
      <div>
        <label className="block text-sm font-medium text-gray-300 mb-2">Customer Testimonials</label>
        <textarea
