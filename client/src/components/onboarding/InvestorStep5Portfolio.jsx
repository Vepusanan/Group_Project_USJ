...
const InvestorStep5Portfolio = ({ formData, updateFormData }) => {
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-2xl font-bold text-white mb-2">Portfolio Perspective</h2>
        <p className="text-gray-400">Provide additional context founders should know.</p>
      </div>

      <div>
        <label className="block text-sm font-medium text-gray-300 mb-2">Deal Breakers</label>
        <textarea
          rows={5}
      ...
      <div>
        <label className="block text-sm font-medium text-gray-300 mb-2">Network Resources</label>
        <textarea
          rows={5}
