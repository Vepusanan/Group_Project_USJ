  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-400">Share portfolio volume and notable outcomes.</p>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
          <label className="block text-sm font-medium text-gray-300 mb-2">Number of Investments</label>
          <input
            type="number"
            min="0"
        ...
        <div>
          <label className="block text-sm font-medium text-gray-300 mb-2">Successful Exits</label>
          <input
            type="number"
            min="0"
      ...
      <div>
        <label className="block text-sm font-medium text-gray-300 mb-2">Portfolio Companies</label>
        <textarea
          rows={5}
      ...
      <div>
        <label className="block text-sm font-medium text-gray-300 mb-2">Notable Achievements</label>
        <textarea
          rows={5}
