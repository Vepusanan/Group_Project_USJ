...
import { Bookmark, MapPin, Sparkles, Tag } from "lucide-react";
import VerificationBadge from "../common/VerificationBadge";
import engagementService from "../../services/engagementService";
import MatchExplanationBlock from "./MatchExplanationBlock";
...
/**
 * Saved-startups list. Rendered inside the investor analytics page (was its own
 * /watchlist page). Self-contained: loads, displays, and removes watchlist items.
 */
  ...
  return (
    <div className="space-y-4">
      <div>
        ...
        <h2 className="text-2xl font-bold text-content">Watchlist</h2>
