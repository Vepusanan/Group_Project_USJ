      ...
      <div className="flex items-start justify-between gap-4">
        <div>
          ...
          <p className="text-xs text-gray-400 mt-1">
            {[
              startup.industry,
              startup.city || startup.location_city,
              startup.country || startup.location_country,
            ]
              .filter(Boolean)
              .join(" • ") || "No location/industry details"}
          </p>
        </div>
        <span
      ...
      <div className="mx-auto max-w-7xl min-h-[calc(100vh-9rem)] flex flex-col">
        ...
        <div className="mt-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3">
          ...
          <input
            ...
            onChange={(event) =>
              handleFilterChange("industry", event.target.value)
            }
            className="w-full rounded-lg bg-black/40 border border-white/20 px-3 py-2 text-white placeholder:text-gray-500"
          />
          <input
            ...
            onChange={(event) =>
              handleFilterChange("location_country", event.target.value)
            }
            className="w-full rounded-lg bg-black/40 border border-white/20 px-3 py-2 text-white placeholder:text-gray-500"
          />
          <select
